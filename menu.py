...
def main_menu_keyboard(is_admin: bool = False):
    ...
    kb.add(InlineKeyboardButton("🧘 Habuild", callback_data="module_habuild", style="primary"))
    kb.add(InlineKeyboardButton("🧘 Yoga", callback_data="module_yoga", style="primary"))
